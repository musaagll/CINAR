...
export default function IletisimPage() {
  return (
    <>
      ...
      {/* Contact Cards */}
      <section className="bg-white py-14 lg:py-20" aria-label="İletişim bilgileri">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex items-center gap-3 max-w-2xl p-5 rounded-2xl bg-[#f7f8fa] border border-[#eef0f4]">
            ...
            <div>
              <p className="text-xs font-semibold text-[#8898aa] uppercase tracking-wider mb-0.5">Hizmet Bölgesi</p>
              <p className="text-sm font-semibold text-[#0f1f3d]">Ankara ve tüm ilçeleri</p>
            </div>
          </div>
        </div>
      </section>
